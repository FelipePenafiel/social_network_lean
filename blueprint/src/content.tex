...
Remark~\ref{rem:green}: does it follow what the paper wrote?  Thirty
...
of its own, so it counts thirty-one entries.

\medskip
\noindent\textbf{Follow the paper's proof} (fourteen).
Propositions~\ref{prop:low-pressure}, \ref{prop:confinement},
\ref{prop:biased-low-pressure}, \ref{prop:biased-bounded}
...
their own \texttt{sorry}.  \texttt{FOR-THE-AUTHORS.md} at the root of
