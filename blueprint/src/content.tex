...
\begin{lemma}[Conservation of trust]
  \label{lem:trust}
  \lean{SocialNetwork.trust_express}
  \leanok
  \uses{def:express}
...
\begin{definition}[The generator, eq.~(3)]
  \label{def:generator}
  \lean{SocialNetwork.generator, SocialNetwork.jumpRate, SocialNetwork.totalRate}
  \leanok
...
\begin{definition}[The skeleton, Definition~3]
  \label{def:skeleton}
  \lean{SocialNetwork.skeletonKernel, SocialNetwork.jumpPMF, SocialNetwork.pathMeasure}
  \leanok
  \uses{def:generator}
...
\begin{definition}[Ladder sets, Definition~1]
  \label{def:ladder}
  \lean{SocialNetwork.IsLadder, SocialNetwork.ladderSet}
  \leanok
  \uses{def:state}
  For $o \in \opinions$,
  \[
...
\begin{definition}[Steep ladders, Definition~4]
  \label{def:steep}
  \lean{SocialNetwork.IsSteepLadder, SocialNetwork.steepLadderSet}
  \leanok
  \uses{def:state}
  \[
...
\begin{lemma}[Steep ladders are stable, Remark~5]
  ...
  \lean{SocialNetwork.IsSteepLadder.express_of_pos, SocialNetwork.mem_steepLadderSet_of_positivePressure}
  \leanok
  \uses{def:steep}
  For $\hat{l} \in \steep$,
...
\begin{definition}[The biased operator, eq.~(5)]
  ...
  \lean{SocialNetwork.Bias.Profile.express, SocialNetwork.Bias.Profile.pressure_express}
  \leanok
...
\begin{definition}[The biased state space, eq.~(6)]
  ...
  \lean{SocialNetwork.Bias.Profile, SocialNetwork.Bias.IsBiasedState}
  \leanok
...
\begin{remark}[Arithmetic of a row, Remark~1]
  ...
  \lean{SocialNetwork.Bias.IsBiasedState.express, SocialNetwork.Bias.Profile.pressure_mem_addSubgroup, SocialNetwork.Bias.Profile.sum_pressure_eq, SocialNetwork.Bias.IsBiasedState.pressure_ne_zero}
  \leanok
...
\begin{definition}[The biased generator, eq.~(7)]
  ...
  \lean{SocialNetwork.Bias.biasedGenerator, SocialNetwork.Bias.biasedSkeletonKernel, SocialNetwork.Bias.biasedCtsPathMeasure}
  \leanok
  \uses{def:biased-state}
  \[
...
\begin{definition}[Biased consensus and ladders, eq.~(8) and (9)]
  ...
  \lean{SocialNetwork.Bias.IsBiasedConsensus, SocialNetwork.Bias.IsBiasedLadder, SocialNetwork.Bias.IsBiasedSteepLadder}
  \leanok
  \uses{def:biased-state}
...
\begin{remark}[The smallest maximum of a non-null row, Remark~8]
  \label{rem:remark8}
  \lean{SocialNetwork.Bias.le_max_pressure}
  \leanok
  \uses{def:biased-state}
...
\begin{definition}[Realisations]
  ...
  \lean{SocialNetwork.Trajectory, SocialNetwork.Trajectory.state, SocialNetwork.skeleton}
  \leanok
  \uses{def:express}
...
\begin{proposition}[Low pressure recurs, Proposition~5]
  ...
  \lean{SocialNetwork.exists_rowSup_actor_lt, SocialNetwork.exists_rowSup_actor_lt_ofPath}
  \leanok
...
\begin{definition}[The greedy event]
  \label{def:greedy}
  \lean{SocialNetwork.IsGreedyAt, SocialNetwork.greedyEvent, SocialNetwork.greedyEvents}
  \leanok
  \uses{def:trajectory}
...
\begin{proposition}[Confinement, Proposition~6]
  ...
  \lean{SocialNetwork.entry_mem_of_greedy, SocialNetwork.entry_mem_of_mem_greedyEvents}
  \leanok
...
\begin{lemma}[From consensus to a ladder]
  ...
  \lean{SocialNetwork.isLadder_state, SocialNetwork.isLadder_state_of_mem_greedyEvents}
  \leanok
...
\begin{proposition}[Reaching a ladder, Proposition~7]
  ...
  \lean{SocialNetwork.isLadder_state_of_greedy, SocialNetwork.greedyEvents_subset_ladder}
  \leanok
...
\begin{lemma}[The gap estimate]
  \label{lem:gap}
  \lean{SocialNetwork.entrySup, SocialNetwork.le_entrySup_sub_one}
  \leanok
  \uses{def:state}
...
\begin{proposition}[Probability of a greedy run, Proposition~8]
  ...
  \lean{SocialNetwork.zeta, SocialNetwork.zeta_le_jumpPMF_argmaxFinset, SocialNetwork.zeta_pow_le_pathMeasure_greedyEvents}
  \leanok
...
\begin{remark}[Bernoulli, Remark~4]
  \label{rem:bernoulli}
  \lean{SocialNetwork.one_sub_le_zeta_pow, SocialNetwork.one_sub_le_pathMeasure_greedyEvents}
  \leanok
...
\begin{definition}[The first repeat time, Definition~5]
  \label{def:tau}
  \lean{SocialNetwork.firstRepeat, SocialNetwork.firstRepeat_le}
  \leanok
  \uses{def:trajectory}
...
\begin{definition}[The near-greedy event, Remark~7]
  ...
  \lean{SocialNetwork.Bias.IsNearGreedyAt, SocialNetwork.Bias.nearGreedyEvents}
  \leanok
  \uses{def:biased-state}
  \[
