...
Remark~\ref{rem:green}: does it follow what the paper wrote?  Twenty-seven
...
of its own, so it counts twenty-eight entries.

\medskip
\noindent\textbf{Follow the paper's proof} (twelve).
...
Corollary~\ref{cor:cbeta}, Theorem~\ref{thm:metastability}, and
...
but needs $\ladder^o \ne \emptyset$, which is
Lemma~\ref{lem:ladder-nonempty}.  Propositions~\ref{prop:biased-bounded}
...
\medskip
\noindent\textbf{No counterpart in the paper} (six).
Lemmas~\ref{lem:trust}, \ref{lem:ladder-consensus}, \ref{lem:state-along},
\ref{lem:consensus-ladder} and~\ref{lem:ladder-nonempty} and
...
argument the authors have not seen.  \texttt{FOR-THE-AUTHORS.md} at the root of
