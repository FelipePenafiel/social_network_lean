...
Remark~\ref{rem:green}: does it follow what the paper wrote?  Thirty-two
...
of its own, so it counts thirty-three entries.

\medskip
\noindent\textbf{Follow the paper's proof} (fifteen).
...
Theorem~\ref{thm:metastability}, and
