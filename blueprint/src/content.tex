...
Theorem~\ref{thm:phase} part~1 and Remark~\ref{rem:remark6} --- simply not
done.
...
Remark~\ref{rem:green}: does it follow what the paper wrote?  Thirty-six
...
of its own, so it counts thirty-seven entries.

\medskip
\noindent\textbf{Follow the paper's proof} (seventeen).
...
and~\ref{prop:biased-absorb}, the gap estimate of Lemma~\ref{lem:gap},
...
\begin{enumerate}
  \item Theorem~\ref{thm:phase} part~1.  Proposition~\ref{prop:biased-absorb},
    on which it rests, is now proved; what part~1 adds is the strong Markov
    property at $T_N$ and the Borel--Cantelli argument over the successive
    failure times $\eta_n$, neither of which the formalisation carries yet.  It
    is the only unproved statement that is nobody's fault, now that
    Lemma~\ref{lem:measurable-hitting} and
    Proposition~\ref{prop:biased-absorb} are closed.
