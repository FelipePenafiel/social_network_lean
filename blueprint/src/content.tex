...
Lemmas~\ref{lem:lemma19} and~\ref{lem:lemma20}, and
Proposition~\ref{prop:biased-confinement}; through them
Propositions~\ref{prop:reach-ladder} and~\ref{prop:biased-reach-ladder}.  See
Remarks~\ref{rem:lemma19}, \ref{rem:lemma20} and~\ref{rem:prop22}: in each case
...
Remark~\ref{rem:green}: does it follow what the paper wrote?  Thirty-seven
...
of its own, so it counts thirty-eight entries.

\medskip
\noindent\textbf{Follow the paper's proof} (eighteen).
Propositions~\ref{prop:low-pressure}, \ref{prop:confinement},
\ref{prop:reach-ladder}, \ref{prop:biased-low-pressure},
...
\begin{enumerate}
  \item Remark~\ref{rem:remark6}, the one numbered statement of the paper with
    no Lean counterpart.  It is the only item left that is nobody's fault, now
    that Lemma~\ref{lem:measurable-hitting},
    Proposition~\ref{prop:biased-absorb} and Theorem~\ref{thm:phase} part~1 are
    closed.  Nothing downstream uses it.
