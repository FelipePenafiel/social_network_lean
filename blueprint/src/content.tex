...
\begin{proof}
  ...
  Corollary~\ref{cor:cbeta}.  \textbf{Not formalised}.
\end{proof}
...
\end{proposition}
\begin{proof}
  This is a consequence of Theorem~5.3 of [LM22].  \textbf{Not formalised}:
  Mathlib has neither that criterion nor the quantitative Kolmogorov-type
  bounds it produces.
\end{proof}
