...
Remark~\ref{rem:green}: does it follow what the paper wrote?  Twenty-five
...
of its own, so it counts twenty-six entries.

\medskip
\noindent\textbf{Follow the paper's proof} (ten).
Propositions~\ref{prop:low-pressure}, \ref{prop:confinement}
and~\ref{prop:biased-low-pressure}, the gap estimate of Lemma~\ref{lem:gap},
