...
Proposition~\ref{prop:biased-absorb}, Theorem~\ref{thm:phase} and
Remark~\ref{rem:remark6} --- simply not done.
...
\begin{enumerate}
  \item Proposition~\ref{prop:biased-absorb}, and Theorem~\ref{thm:phase}
    part~2 with it.  The paper proves both and nothing here stands in the way;
    they are the only unproved statements that are nobody's fault, now that
    Lemma~\ref{lem:measurable-hitting} is closed.
